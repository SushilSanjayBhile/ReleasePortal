...
class DeveloperReport extends Component {
    pageNumber = 0;
    startAt = 0;
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            cusReportColumnDefs: [
                ...
                cusReportColumnDefDict['Developer'],
                cusReportColumnDefDict['Manager'],
                cusReportColumnDefDict['OpenBugs'],
                cusReportColumnDefDict['AvgDays'],
                cusReportColumnDefDict['UE'],
                cusReportColumnDefDict['UA'],
                cusReportColumnDefDict['SP'],
                cusReportColumnDefDict['NA'],
            ],
    ...
    onReportGridReady = params => {
        ...
        this.reportGridApi.setSortModel(sortModel);
        params.api.sizeColumnsToFit();
    };
    ...
    getTcsToShow(){
        ...
        Object.keys(devDict).forEach(key => {
            if(!(QAs[key] === '')){
                ...
                cusReport.push({Developer: key, BU: devDict[key]["BU"], Manager: devDict[key]["Manager"], OpenBugs: devDict[key]["OpenBugs"],
                                ...
                                <div class='col-lg-12'>
                                    <div style={{ display: 'flex' }}>
                                        <div style={{ display: 'inlineBlock' }}>
                                            ...
                                            <span className='rp-app-table-title'>DEVELOPER REPORT</span>
                        ...
                        <Collapse isOpen={this.state.tcOpen}>
                                        ...
                                        <div class="row">
                                            {
                                             ...
                                             <div style={{ width: '2.5rem', marginLeft: '0.5rem' }}>
                                                <Button /*disabled={this.state.isApiUnderProgress}*/ id="PopoverAssign2DR" type="button"><i class="fa fa-filter" aria-hidden="true"></i></Button>
                                                <UncontrolledPopover trigger="legacy" placement="bottom" target="PopoverAssign2DR" id="PopoverAssignButton2DR" toggle={() => this.popoverToggle2()} isOpen={this.state.popoverOpen2}>
                                                    <PopoverBody>
                                                        <div>
                            ...
                            <div>
                                <div style={{ width: '100%', height: '600px', marginBottom: '6rem' }}>
                                    <div class="test-header">
                                        <div class="row">
                                            <div style={{ width: '5rem', marginTop: '0.5rem', right: '1.5rem' }}>
                                                <Button disabled={this.state.isApiUnderProgress} title="Only selected Bugs will be downloaded" size="md" className="rp-rb-save-btn" onClick={() => {
                                                    if (this.reportGridApi) {
