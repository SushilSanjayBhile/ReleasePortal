...
class SpektraAutomationComponent extends Component {
    constructor(props){
        super(props);
    }
    ...
    totalHoursSpent = () => {
         ...
         // https://diamanti.teamwork.com/tasklists/1579938/time/total.json
         const url = `${API_URL}/tasklists/1579938/time/total.json`;
    ...
    totalHoursSpentByEachPerson = () => {
        ...
        axios.get(`${API_URL}/tasklists/1579938/time/total.json`, {
            params: {
                userId:key['id']
                },
            headers: {
            ...
            .then((data) => {
                ...
                console.log("data automation",key['id'],key["name"],data['projects'][0]["tasklist"]["time-totals"]["total-hours-sum"])
    ...
    render(){
        console.log("hello",this.state.dataObj);
        return (
            <div> 
                <div>
                    <h4>Total Employee Working On Spektra Automation : {this.props.users.length}</h4>
                    <h4>Total Hours Spent On Spektra Automation : {this.state.totalHoursSpent}</h4>
                </div>
...
export default SpektraAutomationComponent;