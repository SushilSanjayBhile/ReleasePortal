...
class SpektraNonTestingComponent extends Component {
    constructor(props){
        super(props);
    }
    ...
    totalHoursSpent = () => {
        ...
        const url = `${API_URL}/tasklists/1503197/time/total.json`;
    ...
    totalHoursSpentByEachPerson = () => {
        ...
        axios.get(`${API_URL}/tasklists/1503197/time/total.json`, {
            params: {
                userId:key['id']
                },
            headers: {
            ...
            .then((data) => {
                ...
                console.log("data spektra non testing task",key['id'],key["name"],data['projects'][0]["tasklist"]["time-totals"]["total-hours-sum"])
    ...
    render(){
        return (
            <div> 
                <div>
                    <h4>Total Employee Working On Spektra Non Testing: {this.props.users.length}</h4>
                    <h4>Total Hours Spent On Spektra Non Testing : {this.state.totalHoursSpent}</h4>
                </div>
...
export default SpektraNonTestingComponent;
