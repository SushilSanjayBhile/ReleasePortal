...
class Release_2_3_0_Component extends Component {
    constructor(props){
        super(props);
    }
    ...
    totalHoursSpent = () => {
        ...
        const url = `${API_URL}/tasklists/1334078/time/total.json`;
    ...
    totalHoursSpentByEachPerson = () => {
        ...
        axios.get(`${API_URL}/tasklists/1334078/time/total.json`, {
            params: {
                userId:key['id']
                },
            headers: {
            ...
            .then(response => response.data)
            .then((data) => {
                // console.log("hhahhajajscascnsbafhas",data);
                // console.log("data coming",data);
                if(data['projects'][0]["tasklist"]["time-totals"]["total-hours-sum"] != 0){
                console.log("data 2.3.0",key['id'],key["name"],data['projects'][0]["tasklist"]["time-totals"]["total-hours-sum"])
    ...
    render(){
        return (
            <div> 
                <div>
                    <h4>Total Employee Working On 2.3.0 : {this.props.users.length}
                    {/* <Button  outline className="float-right">Close</Button> */}

                    </h4>
                    <h4>Total Hours Spent On 2.3.0 : {this.state.totalHoursSpent}</h4>
                </div>
...
export default Release_2_3_0_Component;
