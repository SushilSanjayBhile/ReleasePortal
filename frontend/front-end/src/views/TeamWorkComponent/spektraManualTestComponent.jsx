...
class SpektraManualTestComponent extends Component {
    constructor(props){
        super(props);
    ...
    totalHoursSpent = () => {
        ...
        const url = `${API_URL}/tasklists/1579939/time/total.json`;
    ...
    totalHoursSpentByEachPerson = () => {
        ...
        axios.get(`${API_URL}/tasklists/1579939/time/total.json`, {
            ...
            .then((data) => {
                ...
                console.log("data",key['id'],key["name"],data['projects'][0]["tasklist"]["time-totals"]["total-hours-sum"])
    ...
    render(){
        ...
        console.log("dataObj",this.state.dataObj);
        
        return (
            <div> 
                <div>
                    <h4>Total Employee Working On Spektra Manual Test : {this.props.users.length}</h4>
                    <h4>Total Hours Spent On Spektra Manual Test : {this.state.totalHoursSpent}</h4>
                </div>
                <div>
                    <Table {...this.state} />
                </div>
...
export default SpektraManualTestComponent;