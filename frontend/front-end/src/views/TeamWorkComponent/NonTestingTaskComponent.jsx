...
class NonTestingTaskComponent extends Component {
    constructor(props){
        super(props);
    }
    ...
    totalHoursSpent = () => {
        ...
        const url = `${API_URL}/tasklists/1433012/time/total.json`;
    ...
    totalHoursSpentByEachPerson = () => {
        ...
        axios.get(`${API_URL}/tasklists/918099/time/total.json`, {
            ...
            .then((data) => {
                ...
                console.log("data Non Testing Task",key['id'],key["name"],data['projects'][0]["tasklist"]["time-totals"]["total-hours-sum"])
    ...
    render(){
        return (
            <div> 
                <div>
                    <h4>Total Employee Working On Non Testing Task : {this.props.users.length}
                    {/* <Button  outline className="float-right">Close</Button> */}

                    </h4>
                    <h4>Total Hours Spent On Non Testing Task  : {this.state.totalHoursSpent}</h4>
                </div>
...
export default NonTestingTaskComponent;