...
class adminDashboardGUI extends Component {
    cntr = 0;
    pageNumber = 0;
    rows = 15;
    editedRows = {};
    ...
    popoverTogglePlatformGUI = () => this.setState({popoverOpenPlatformGUI: !this.state.popoverOpenPlatformGUI })
    ...
    savePlatormInfo(){
        ...
        if (this.props.selectedRelease.ReleaseNumber == "DCX-DMC-Master"){
            ...
            .then(response=>{
                this.gridOperations(true);
                //this.getTcs(true, this.state.CardType, this.state.platform, this.state.domain, this.state.subDomain, false, false, false, true)
                this.getTcs(true, this.state.CardType, this.state.platform, null, null, false, false, false, true)
...
export default connect(mapStateToProps, { saveTestCase, getCurrentRelease, saveSingleTestCase, updateTCEdit, saveReleaseBasicInfo })(adminDashboardGUI);
