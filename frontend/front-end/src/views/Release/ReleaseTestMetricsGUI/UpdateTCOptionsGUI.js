...
class UpdateTCOptionsGUI extends Component {
    constructor(props) {
        super(props);
        this.state = {
            open: false,
...
export default connect(mapStateToProps, { saveTestCase, saveTestCaseStatus, saveSingleTestCase, updateTCEdit })(UpdateTCOptionsGUI);
