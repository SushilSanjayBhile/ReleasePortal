...
class UNAPPROVEDTC extends Component {
    ...
    popoverToggleUNAPPROVED = () => this.setState({ popoverOpenUNAPPROVED: !this.state.popoverOpenUNAPPROVED },()=>{
    });
    popoverToggleUNAPPROVED = () => this.setState({ popoverOpenUNAPPROVED : !this.state.popoverOpenUNAPPROVED });
    reset() {
    ...
    render() {
        ...
        return (
            <div>
                                        ...
                                        <div class="row">
...

                                            {
                                                ...
                                                <div style={{ width: '8rem', marginLeft: '0.5rem' }}>
                                                    <span>
                                                        <Button  id="PopoverAssignUNAPPROVED" type="button">Apply Multiple</Button>
                                                        <UncontrolledPopover trigger="legacy" placement="bottom" target="PopoverAssignUNAPPROVED" id="PopoverAssignButtonUNAPPROVED" toggle={() => this.popoverToggleUNAPPROVED()} isOpen={this.state.popoverOpenUNAPPROVED}>
                                                            <PopoverBody>
                                                                {
                                                                    [
                                                                ...
                                                                <div style={{ float: 'right', marginBottom: '0.5rem' }}>
                                                                    ...
                                                                    <span>
                                                                        {
                                                                            this.isAnyChanged &&
                                                                            <Button  title="Save" size="md" className="rp-rb-save-btn" onClick={() => { this.popoverToggleUNAPPROVED(); this.toggleAllUNAPPROVED() }} >
                                                                                Save
                                                                            </Button>
                                                                        }
                                                                    </span>
                ...
                <Modal isOpen={this.state.multipleChanges} toggle={() => this.toggleAllUNAPPROVED()}>
                    {
                        <ModalHeader toggle={() => this.toggleAllUNAPPROVED()}>{
                            'Confirmation'
                        }</ModalHeader>
                    }
                    <ModalBody>
                    ...
                    <ModalFooter>
                        <Button color="primary" onClick={() => { this.toggleAllUNAPPROVED(); this.saveAll(); }}>Ok</Button>{' '}
                        {
                            <Button color="secondary" onClick={() => this.toggleAllUNAPPROVED()}>Cancel</Button>
                        }
                    </ModalFooter>
                </Modal>
...
export default connect(mapStateToProps, { saveUserPendingApproval, saveTestCase, getCurrentRelease, saveSingleTestCase, updateTCEdit })(UNAPPROVEDTC);
