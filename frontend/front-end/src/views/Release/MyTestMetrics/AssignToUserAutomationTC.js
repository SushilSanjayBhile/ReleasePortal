...
class AssignToUserAutomationTC extends Component {
    cntr = 0;
    pageNumber = 0;
    rows = 15;
    editedRows = {};
    ...
    constructor(props) {
        ...
        let columnDefDict = {
            ...
            'CardType' : {
                headerName: "Platform", field: "CardType", sortable: true, filter: true, cellStyle: this.renderEditedCell, width: '100',
                //cellEditor: 'selectionEditor',
                cellClass: 'cell-wrap-text',
                editable: false,
                // cellEditorParams: {
   ...
   //Priority Based Filter functions
    ...
    popoverToggle1 = () => this.setState({ popoverOpenAutomationCLI1: !this.state.popoverOpenAutomationCLI1 });
    popoverToggle2 = () => this.setState({ popoverOpenAUtomationCLI2: !this.state.popoverOpenAUtomationCLI2 });
    ...
    onCellEditing = (params, field, value) => {
        // console.log("onCellEditing",params,field,value)
        if (this.editedRows[`${params.TcID}_${params.CardType}`]) {
            ...
            // console.log("onCellEditing if if",this.editedRows)
            ...
            // console.log("onCellEditing if else",this.editedRows)
        }
    }
    ...
    saveAll() {
        ...
        selectedRows.forEach(item => {
            ...
            ['Priority', 'Assignee',  'WorkingStatus', 'OS'].map(each => {
                console.log("field",each,"value",item[each])
                if (item[each]) {
    ...
    saveMultipleTcStatus(statusItems, items) {
        this.gridOperations(false);
        console.log("before tc status update",statusItems)
    ...
    saveMultipleTcInfo(items) {
        this.gridOperations(false);
        console.log("before put request",items)
                                ...
                                <div class='col-lg-12'>
                                    <div style={{ display: 'flex' }}>
                                        <div style={{ display: 'inlineBlock' }}>
                                            ...
                                            <span className='rp-app-table-title'>Automation Test Cases</span>
                                ...
                                <div style={{ width: '100%', height: '600px', marginBottom: '6rem' }}>
                                    <div class="test-header">
                                        <div class="row">
                                            ...
                                            <div style={{ width: '2.5rem', marginLeft: '0.5rem' }}>
                                                <Button id="AssignToUserAutoTcCLI2" type="button"><i class="fa fa-filter" aria-hidden="true"></i></Button>
                                                <UncontrolledPopover trigger="legacy" placement="bottom" target="AssignToUserAutoTcCLI2" id="AssignToUserAutoTcCLI2Button" toggle={() => this.popoverToggle2()} isOpen={this.state.popoverOpenAUtomationCLI2}>
                                                    <PopoverBody>
                                                        <div>
                                            ...
                                            <div style={{ width: '2.5rem', marginLeft: '0.5rem' }}>
                                                <Button id="PopoverAssignAutomationCLI1" type="button"><i class="fa fa-columns" aria-hidden="true"></i></Button>
                                                <UncontrolledPopover trigger="legacy" placement="bottom" target="PopoverAssignAutomationCLI1" id="PopoverAssignButtonAutomationCLI1" toggle={() => this.popoverToggle1()} isOpen={this.state.popoverOpenAutomationCLI1}>
                                                    <PopoverBody>
                                                        <div>
                                            ...
                                            </div>
                                            {
                                                ...
                                                <div style={{ width: '8rem', marginLeft: '0.5rem' }}>
                                                    <span>
                                                        <Button disabled={this.state.isApiUnderProgress} id="PopoverAssignApplyMutiple" type="button">Apply Multiple</Button>
                                                        <UncontrolledPopover trigger="legacy" placement="bottom" target="PopoverAssignApplyMutiple" id="PopoverAssignApplyMutipleButton" toggle={() => this.popoverToggle()} isOpen={this.state.popoverOpen}>
                                                            <PopoverBody>
                                                                {
                                                                    [
                                                                        ...
                                                                        <Input disabled={this.state.isApiUnderProgress} value={this.state.multi && this.state.multi[each.labels]} onChange={(e) => {
                                                                            ...
                                                                            this.setState({ multi: { ...this.state.multi, [each.labels]: e.target.value } },()=>{
                                                                                // console.log("after setting assingee and working status",this.state.multi)
                                                                            })
                                                                            setTimeout(this.gridApi.redrawRows(), 0);
...
export default connect(mapStateToProps, { saveTestCase, getCurrentRelease, saveSingleTestCase, updateTCEdit, saveReleaseBasicInfo })(AssignToUserAutomationTC);
