...
class AssignToUserGUI extends Component {
    cntr = 0;
    pageNumber = 0;
    rows = 15;
    editedRows = {};
   ...
   updateReleaseInfo() {
    ...
    saveAll() {
        ...
        selectedRows.forEach(item => {
            ...
            if (this.state.multi && this.state.multi.Build) {
                ...
                status.stateUserMapping =  {"Manual Assignee":item.Assignee,"Manual WorkingStatus" : "MANUAL_COMPLETED"}
                status.Activity = {
                    Release: this.props.selectedRelease.ReleaseNumber,
                    "tcInfoNum":item.id,
                    "TcID": item.TcID,
    ...
    save() {
        ...
        let Manual_Assignee = stateUserMapping["Manual Assignee"];
                            ...
                            <div class="row">
                                <div class='col-lg-12'>
                                    ...
                                    <div style={{ display: 'inlineBlock' }}>
                                            ...
                                            <span className='rp-app-table-title'>Manual Test Cases For GUI</span>
...
export default connect(mapStateToProps, { saveTestCase, getCurrentRelease, saveSingleTestCase, updateTCEdit, saveReleaseBasicInfo })(AssignToUserGUI);
