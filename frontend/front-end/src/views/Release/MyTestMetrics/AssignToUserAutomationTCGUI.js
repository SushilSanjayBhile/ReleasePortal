...
import { Col, Row, Button,UncontrolledPopover, PopoverBody,
    Modal, ModalHeader, ModalBody, ModalFooter, Input, FormGroup, Label, Collapse
} from 'reactstrap';
import '../../../components/TestCasesAllGUI/TestCasesAllGUI.scss';
import { AgGridReact } from 'ag-grid-react';
import { AllCommunityModules } from "@ag-grid-community/all-modules";
import "@ag-grid-community/all-modules/dist/styles/ag-grid.css";
import "@ag-grid-community/all-modules/dist/styles/ag-theme-balham.css";
import MoodEditor from "../../../components/TestCasesAllGUI/moodEditor";
import MoodRenderer from "../../../components/TestCasesAllGUI/moodRenderer";
import NumericEditor from "../../../components/TestCasesAllGUI/numericEditor";
import SelectionEditor from '../../../components/TestCasesAllGUI/selectionEditor';
import DatePickerEditor from '../../../components/TestCasesAllGUI/datePickerEditor';
import EditTCGUI from '../../../views/Release/ReleaseTestMetricsGUI/EditTCGUI';
import { roles, wsA, tcTypes } from '../../../constants';
...
class AssignToUserAutomationTCGUI extends Component {
    cntr = 0;
    pageNumber = 0;
    rows = 15;
    editedRows = {};
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            selectedRows: 0,
            totalRows: 0,
            overlayLoadingTemplate: '<span class="ag-overlay-loading-center" style="color:red"><b>Please wait while table or Tc is loading</b></span>',
            overlayNoRowsTemplate: '<span class="ag-overlay-loading-center" style="color:red">No rows to show</span>',
            rowSelect: false,
            isEditing: false,
            delete: false,
    ...
    popoverToggle1 = () => this.setState({ popoverOpenAutomationGUI1: !this.state.popoverOpenAutomationGUI1 });
    popoverToggle2 = () => this.setState({ popoverOpenAutomationGUI2: !this.state.popoverOpenAutomationGUI2 });
   ...
   updateReleaseInfo() {
    ...
    getTcs(CardType, domain, subDomain, priority, all, selectedRelease, updateRelease) {
        ...
        url += ('&WorkingStatus=' + 'Automation Assignee')
    ...
    saveAll() {
        ...
        selectedRows.forEach(item => {
            ...
            if (this.state.multi && this.state.multi.Build) {
                ...
                status.stateUserMapping =  {"Automation Assignee":item.Assignee,"Automation WorkingStatus" : "AUTO_COMPLETED"}
            ...
            if(statusFlag == 1){
                pushable["Automation WorkingStatus"] = "AUTO_COMPLETED"
                pushable["Automation Assignee"] = item.Assignee
            }
    ...
    save() {
        ...
        stateUserMapping = stateUserMapping.replace(/'/g,'"');
        stateUserMapping = JSON.parse(stateUserMapping);
        ...
        let Automation_Assignee = stateUserMapping["Automation Assignee"];
        let Automation_WorkingStatus = stateUserMapping["Automation WorkingStatus"]

        if(this.props.testcaseEdit.TcName != "TC NOT AUTOMATED"){
            Automation_WorkingStatus = "AUTO_COMPLETED";
        }

        data.stateUserMapping = {"Automation Assignee":Automation_Assignee,"Automation WorkingStatus":Automation_WorkingStatus}
    ...
    saveSingleTCInfo(data) {
        ...
        // data.stateUserMapping = {"CREATED" : data.Assignee}

        // if(data["Manual Assignee"] == 'undefined'){
        //     delete data["Manual Assignee"]
        // }
        // if(data["Manual WorkingStatus"] == 'undefined'){
        //     delete data["Manual WorkingStatus"]
        // }
        if(data["Automation Assignee"] == 'undefined'){
            delete data["Automation Assignee"]
        }
        if(data["Automation Assignee"] == 'undefined'){
            delete data["Automation Assignee"]
        }

        console.log("coming in save single tc info",data)
                            ...
                            <div class="row">
                                <div class='col-lg-12'>
                                    ...
                                    <div onClick={() => {
                                            ...
                                            <span className='rp-app-table-title'>Automation Test Cases For GUI</span>
                                ...
                                <div style={{ width: '100%', height: '600px', marginBottom: '6rem' }}>
                                    <div class="test-header">
                                        <div class="row">
                                            ...
                                            <div style={{ width: '2.5rem', marginLeft: '0.5rem' }}>
                                                <Button id="PopoverAssignAutomationGUI2" type="button"><i class="fa fa-filter" aria-hidden="true"></i></Button>
                                                <UncontrolledPopover trigger="legacy" placement="bottom" target="PopoverAssignAutomationGUI2" id="PopoverAssignButtonAutomationGUI2" toggle={() => this.popoverToggle2()} isOpen={this.state.popoverOpenAutomationGUI2}>
                                                    <PopoverBody>
                                                        <div>
                                            ...
                                            <div style={{ width: '2.5rem', marginLeft: '0.5rem' }}>
                                                <Button id="PopoverAssignAutomationGUI1" type="button"><i class="fa fa-columns" aria-hidden="true"></i>
                                                    </Button>
                                                <UncontrolledPopover trigger="legacy" placement="bottom" target="PopoverAssignAutomationGUI1" id="PopoverAssignButtonAutomationGUI1" toggle={() => this.popoverToggle1()} isOpen={this.state.popoverOpenAutomationGUI1}>
                                                    <PopoverBody>
                                                        <div>
                                            ...
                                            </div>
                                            {
                                                ...
                                                <div style={{ width: '8rem', marginLeft: '0.5rem' }}>
                                                    <span>
                                                        <Button disabled={this.state.isApiUnderProgress} id="PopoverAssignApplyMultipleAutomatioGUI" type="button">Apply Multiple</Button>
                                                        <UncontrolledPopover trigger="legacy" placement="bottom" target="PopoverAssignApplyMultipleAutomatioGUI" id="PopoverAssignApplyMultipleAutomatioGUI" toggle={() => this.popoverToggle()} isOpen={this.state.popoverOpen}>
                                                            <PopoverBody>
                                                                {
                                                                    [
...
export default connect(mapStateToProps, { saveTestCase, getCurrentRelease, saveSingleTestCase, updateTCEdit, saveReleaseBasicInfo })(AssignToUserAutomationTCGUI);
