...
app.use('/rest/jira/bugdata', (req, res) => {
    var totalBugsStr = `/rest/gadget/1.0/twodimensionalfilterstats/generate?filterId=filter-13644&xstattype=statuses&ystattype=allFixfor&sortDirection=desc&sortBy=total&numberToShow=1000` 
