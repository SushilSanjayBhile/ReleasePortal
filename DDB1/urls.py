...
from .tcinfo import TC_INFO_GET_POST_VIEW, SPECIFIC_TC_INFO_BY_ID, WHOLE_TC_INFO, MULTIPLE_TC_UPDATION, SPECIFIC_TC_INFO_BY_ID2
...
urlpatterns = [
    ...
    path('tcinfoput/<str:Release>/id/<str:id>/card/<str:card>', SPECIFIC_TC_INFO_BY_ID2),
