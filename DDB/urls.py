...
from .tcinfo import TC_INFO_GET_POST_VIEW, GET_TC_INFO_BY_ID, WHOLE_TC_INFO, MULTIPLE_TC_UPDATION, UPDATE_TC_INFO_BY_ID, TcCountByFilter, WHOLE_GUI_TC_INFO, UpdateTcStatusView
...
urlpatterns = [
    ...
    path("<str:Release>/updatestatus", UpdateTcStatusView),
