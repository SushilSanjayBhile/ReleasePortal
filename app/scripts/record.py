...
"""
    ...
    newfp = open("/app/dp/newsettings.py", "w+")
    newfp.write(contents)
    newfp.close()

    os.system("cp /app/dp/settings.py /app/dp/oldsettings.py")
    os.system("mv /app/dp/newsettings.py /app/dp/settings.py")

    os.system("python3 /app/dp/manage.py makemigrations")
    os.system("python3 /app/dp/manage.py migrate --database=" + release)
